...
current list can be seen by running:
    ...
    electrum-aquariuscoin-server peers
...
`electrum-aquariuscoin-server peers` will always return an empty list.
...
composing the IRC nickname to identify your server on #electrum-aquariuscoin.
